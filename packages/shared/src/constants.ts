...
export const VERTICALS: VerticalMeta[] = [
  // Core
  { vertical: "foundation_models", label: "Foundation Models", ring: "core", color: "#e63946", angle: 0 },
  ...
  { vertical: "code_generation", label: "Code Generation", ring: "inner", color: "#264653", angle: 216 },
  { vertical: "multimodal", label: "Multimodal", ring: "inner", color: "#a855f7", angle: 288 },
  // Mid ring
  { vertical: "safety_alignment", label: "Safety & Alignment", ring: "mid", color: "#ef4444", angle: 0 },
  { vertical: "evaluation", label: "Evaluation", ring: "mid", color: "#f97316", angle: 60 },
  { vertical: "developer_tooling", label: "Developer Tooling", ring: "mid", color: "#06b6d4", angle: 120 },
  { vertical: "enterprise_platforms", label: "Enterprise Platforms", ring: "mid", color: "#8b5cf6", angle: 180 },
  { vertical: "data_infrastructure", label: "Data Infrastructure", ring: "mid", color: "#14b8a6", angle: 240 },
  ...
  { vertical: "consumer_products", label: "Consumer Products", ring: "outer", color: "#ec4899", angle: 51 },
  { vertical: "creative_tools", label: "Creative Tools", ring: "outer", color: "#d946ef", angle: 103 },
  { vertical: "search_retrieval", label: "Search & Retrieval", ring: "outer", color: "#0ea5e9", angle: 154 },
  ...
  { vertical: "governance_policy", label: "Governance & Policy", ring: "periphery", color: "#78716c", angle: 180 },
];
...
export const NODE_STATUSES: NodeStatus[] = [
  "announced", "alpha", "beta", "ga", "deprecated", "acquired", "shutdown",
];
...
export const EVENT_TYPES: EventType[] = [
  "launch", "funding", "release", "acquisition", "paper", "update", "shutdown",
];
