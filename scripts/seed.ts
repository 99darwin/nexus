    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Claude 3 family launched",
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Gemini model family announced",
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Llama 3 released",
        source_url: "https://ai.meta.com/llama3",
      },
    ],
    significance: 0.9,
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Mistral Large released",
        source_url: "https://mistral.ai/news/mistral-large",
      },
    ],
    significance: 0.8,
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "B200 GPU announced at GTC",
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "AI-powered Bing and Copilot announced",
        source_url:
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "AI Overviews launched in Search",
        source_url: "https://blog.google/products/search/generative-ai-google-search-may-2024/",
      },
    ],
    significance: 0.9,
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Grok-1.5 released",
        source_url: "https://x.ai/blog/grok-1.5",
      },
    ],
    significance: 0.7,
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Stable Diffusion 3 announced",
    ...
    events: [
      {
        ...
        event_type: "update",
        summary: "Surpassed 1M models on the Hub",
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "GPT-4o launched with native multimodal capabilities",
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "o1 reasoning model released",
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Claude 4 Opus released as most capable model",
    ...
    events: [
      {
        timestamp: "2025-05-22T00:00:00Z",
        event_type: "launch",
        summary: "Claude 4 Sonnet released",
        source_url: "https://anthropic.com/claude-4",
      },
    ],
    significance: 0.88,
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Claude 4 Haiku released for fast inference",
        source_url: "https://anthropic.com/claude-4-haiku",
      },
    ],
    significance: 0.75,
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Claude 3.5 Sonnet released",
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Gemini 2.5 Pro released with thinking capabilities",
        source_url: "https://deepmind.google/technologies/gemini/2-5-pro/",
      },
    ],
    significance: 0.9,
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Llama 4 released as open-weight model",
        source_url: "https://ai.meta.com/llama4",
      },
    ],
    significance: 0.88,
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Gemini 1.5 Pro with 1M context",
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Grok-2 released",
        source_url: "https://x.ai/blog/grok-2",
      },
    ],
    significance: 0.6,
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "SD3 Medium weights released",
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "DALL-E 3 released integrated with ChatGPT",
        source_url: "https://openai.com/dall-e-3",
      },
    ],
    significance: 0.72,
    ...
    events: [
      {
        ...
        event_type: "update",
        summary: "GPTs custom chatbot platform launched",
        source_url: "https://openai.com/blog/introducing-gpts",
      },
    ],
    significance: 0.95,
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Claude Code launched as agentic coding CLI",
        source_url: "https://anthropic.com/claude-code",
      },
    ],
    significance: 0.78,
    ...
    events: [
      {
        ...
        event_type: "update",
        summary: "Copilot Workspace preview announced",
    ...
    events: [
      {
        ...
        event_type: "update",
        summary: "Cursor reached $100M ARR",
    ...
    events: [
      {
        ...
        event_type: "funding",
        summary: "Series B at $1B valuation",
    ...
    events: [
      {
        ...
        event_type: "update",
        summary: "Midjourney v6.1 released with improved coherence",
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "Sora launched for ChatGPT Pro/Plus users",
    ...
    events: [
      {
        ...
        event_type: "update",
        summary: "Audio Overview feature launched",
        source_url: "https://blog.google/technology/ai/notebooklm-audio-overviews/",
      },
    ],
    significance: 0.6,
    ...
    events: [
      {
        ...
        event_type: "update",
        summary: "LangChain v0.1 stable release",
        source_url: "https://blog.langchain.dev/langchain-v0-1-0/",
      },
    ],
    significance: 0.78,
    ...
    events: [
      {
        timestamp: "2024-06-01T00:00:00Z",
        event_type: "update",
        summary: "Transformers v4.41 with Gemma 2 support",
    ...
    events: [
      {
        ...
        event_type: "update",
        summary: "vLLM v0.3 with speculative decoding",
    ...
    events: [
      {
        ...
        event_type: "update",
        summary: "PyTorch 2.4 released with updated torch.compile",
    ...
    events: [
      {
        ...
        event_type: "update",
        summary: "LlamaIndex v0.10 with modular architecture",
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "MMLU widely adopted as LLM benchmark",
    ...
    events: [
      {
        timestamp: "2023-01-01T00:00:00Z",
        event_type: "launch",
        summary: "HumanEval established as code gen benchmark",
    ...
    events: [
      {
        timestamp: "2024-04-01T00:00:00Z",
        event_type: "update",
        summary: "SWE-bench Verified released with human-validated subset",
    ...
    events: [
      {
        ...
        event_type: "paper",
        summary: "Transformer architecture paper published",
    ...
    events: [
      {
        ...
        event_type: "paper",
        summary: "Kaplan et al. scaling laws paper published",
        source_url: "https://arxiv.org/abs/2001.08361",
      },
    ],
    significance: 0.85,
    summary:
      "Seminal paper establishing power-law relationships between model size, data, and performance.",
    ...
    events: [
      {
        ...
        event_type: "paper",
        summary: "Constitutional AI paper published by Anthropic",
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "The Pile 825GB open dataset released",
    ...
    events: [
      {
        timestamp: "2023-01-01T00:00:00Z",
        event_type: "update",
        summary: "Ongoing monthly web crawl dataset",
    ...
    events: [
      {
        ...
        event_type: "update",
        summary: "EU AI Act formally approved by European Parliament",
        source_url:
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "NIST AI RMF 1.0 published",
        source_url:
    ...
    events: [
      {
        ...
        event_type: "launch",
        summary: "H100 became widely available",
        source_url: "https://nvidia.com/h100",
      },
    ],
    significance: 0.9,
    ...
    events: [
      {
        timestamp: "2024-03-18T00:00:00Z",
        event_type: "launch",
        summary: "B200 GPU announced at GTC 2024",
        source_url: "https://nvidia.com/gtc",
      },
    ],
    significance: 0.85,
...
const edges: GraphEdge[] = [
  ...
  {
    source_id: "openai/gpt-4o",
    target_id: "openai",
    relationship: "authored_by",
    discovered_at: "2024-05-13T00:00:00Z",
    confidence: 0.99,
    evidence: "GPT-4o created by OpenAI",
  },
  {
    ...
    discovered_at: "2023-03-14T00:00:00Z",
    confidence: 0.99,
    evidence: "GPT-4 created by OpenAI",
  },
  {
    source_id: "openai/o1",
    target_id: "openai",
    ...
    discovered_at: "2024-09-12T00:00:00Z",
    confidence: 0.99,
    evidence: "o1 created by OpenAI",
  },
  {
    source_id: "openai/chatgpt",
    target_id: "openai",
    relationship: "authored_by",
    discovered_at: "2023-01-01T00:00:00Z",
    confidence: 0.99,
    evidence: "ChatGPT is an OpenAI product",
  },
  {
    source_id: "openai/dall-e-3",
    target_id: "openai",
    relationship: "authored_by",
    discovered_at: "2023-10-03T00:00:00Z",
    confidence: 0.99,
    evidence: "DALL-E 3 created by OpenAI",
  },
  {
    source_id: "openai/sora",
    target_id: "openai",
    relationship: "authored_by",
    discovered_at: "2024-02-15T00:00:00Z",
    confidence: 0.99,
    evidence: "Sora created by OpenAI",
  },
  {
    source_id: "anthropic/claude-4-opus",
    target_id: "anthropic",
    relationship: "authored_by",
    discovered_at: "2025-05-22T00:00:00Z",
    confidence: 0.99,
    evidence: "Claude 4 Opus by Anthropic",
  },
  {
    source_id: "anthropic/claude-4-sonnet",
    target_id: "anthropic",
    relationship: "authored_by",
    discovered_at: "2025-05-22T00:00:00Z",
    confidence: 0.99,
    evidence: "Claude 4 Sonnet by Anthropic",
  },
  {
    source_id: "anthropic/claude-4-haiku",
    target_id: "anthropic",
    relationship: "authored_by",
    discovered_at: "2025-06-01T00:00:00Z",
    confidence: 0.99,
    evidence: "Claude 4 Haiku by Anthropic",
  },
  {
    source_id: "anthropic/claude-3-5-sonnet",
    target_id: "anthropic",
    relationship: "authored_by",
    discovered_at: "2024-06-20T00:00:00Z",
    confidence: 0.99,
    evidence: "Claude 3.5 Sonnet by Anthropic",
  },
  {
    ...
    discovered_at: "2025-02-24T00:00:00Z",
    confidence: 0.99,
    evidence: "Claude Code by Anthropic",
  },
  {
    source_id: "google/gemini-2-5-pro",
    target_id: "google-deepmind",
    relationship: "authored_by",
    discovered_at: "2025-03-25T00:00:00Z",
    confidence: 0.99,
    evidence: "Gemini 2.5 Pro by Google DeepMind",
  },
  {
    source_id: "google/gemini-1-5-pro",
    target_id: "google-deepmind",
    relationship: "authored_by",
    discovered_at: "2024-02-15T00:00:00Z",
    confidence: 0.99,
    evidence: "Gemini 1.5 Pro by Google DeepMind",
  },
  {
    source_id: "google/notebooklm",
    target_id: "google",
    relationship: "authored_by",
    discovered_at: "2023-07-12T00:00:00Z",
    confidence: 0.99,
    evidence: "NotebookLM is a Google product",
  },
  {
    source_id: "meta/llama-4",
    target_id: "meta-ai",
    relationship: "authored_by",
    discovered_at: "2025-04-05T00:00:00Z",
    confidence: 0.99,
    evidence: "Llama 4 by Meta AI",
  },
  {
    source_id: "meta/llama-3",
    target_id: "meta-ai",
    relationship: "authored_by",
    discovered_at: "2024-04-18T00:00:00Z",
    confidence: 0.99,
    evidence: "Llama 3 by Meta AI",
  },
  {
    source_id: "mistral/mistral-large",
    target_id: "mistral",
    relationship: "authored_by",
    discovered_at: "2024-02-26T00:00:00Z",
    confidence: 0.99,
    evidence: "Mistral Large by Mistral AI",
  },
  {
    source_id: "xai/grok-2",
    target_id: "xai",
    relationship: "authored_by",
    discovered_at: "2024-08-13T00:00:00Z",
    confidence: 0.99,
    evidence: "Grok-2 by xAI",
  },
  {
    source_id: "stability-ai/sd3",
    target_id: "stability-ai",
    relationship: "authored_by",
    discovered_at: "2024-02-22T00:00:00Z",
    confidence: 0.99,
    evidence: "SD3 by Stability AI",
  },
  {
    source_id: "huggingface/transformers",
    target_id: "huggingface",
    relationship: "authored_by",
    discovered_at: "2023-01-01T00:00:00Z",
    confidence: 0.99,
    evidence: "Transformers library by Hugging Face",
  },
  {
    source_id: "paper/constitutional-ai",
    target_id: "anthropic",
    relationship: "authored_by",
    discovered_at: "2022-12-15T00:00:00Z",
    confidence: 0.99,
    evidence: "Constitutional AI paper by Anthropic researchers",
  },
  {
    ...
    discovered_at: "2023-01-01T00:00:00Z",
    confidence: 0.99,
    evidence: "H100 manufactured by NVIDIA",
  },
  {
    source_id: "nvidia/b200",
    target_id: "nvidia",
    relationship: "authored_by",
    discovered_at: "2024-03-18T00:00:00Z",
    confidence: 0.99,
    evidence: "B200 manufactured by NVIDIA",
  },
  ...
  // succeeded_by chains
  {
    ...
    discovered_at: "2024-05-13T00:00:00Z",
    confidence: 0.95,
    evidence: "GPT-4o succeeds GPT-4 as flagship model",
  },
  {
    source_id: "anthropic/claude-3-5-sonnet",
    target_id: "anthropic/claude-4-sonnet",
    relationship: "succeeded_by",
    discovered_at: "2025-05-22T00:00:00Z",
    confidence: 0.95,
    evidence: "Claude 4 Sonnet succeeds Claude 3.5 Sonnet",
  },
  {
    source_id: "google/gemini-1-5-pro",
    target_id: "google/gemini-2-5-pro",
    relationship: "succeeded_by",
    discovered_at: "2025-03-25T00:00:00Z",
    confidence: 0.95,
    evidence: "Gemini 2.5 Pro succeeds 1.5 Pro",
  },
  {
    source_id: "meta/llama-3",
    target_id: "meta/llama-4",
    relationship: "succeeded_by",
    discovered_at: "2025-04-05T00:00:00Z",
    confidence: 0.95,
    evidence: "Llama 4 succeeds Llama 3",
  },
  {
    source_id: "nvidia/h100",
    ...
    discovered_at: "2024-03-18T00:00:00Z",
    confidence: 0.9,
    evidence: "B200 is the next-gen GPU after H100",
  },
  ...
  // built_on relationships
  {
    ...
    discovered_at: "2024-05-13T00:00:00Z",
    confidence: 0.95,
    evidence: "ChatGPT uses GPT-4o as default model",
  },
  {
    source_id: "anthropic/claude-code",
    target_id: "anthropic/claude-4-sonnet",
    ...
    discovered_at: "2025-05-22T00:00:00Z",
    confidence: 0.9,
    evidence: "Claude Code uses Sonnet as default model",
  },
  {
    source_id: "google/notebooklm",
    target_id: "google/gemini-2-5-pro",
    ...
    discovered_at: "2025-03-25T00:00:00Z",
    confidence: 0.85,
    evidence: "NotebookLM powered by Gemini",
  },
  {
    ...
    confidence: 0.7,
    evidence: "Perplexity uses multiple models including GPT-4o",
  },
  {
    source_id: "cursor",
    target_id: "anthropic/claude-4-sonnet",
    ...
    discovered_at: "2025-05-22T00:00:00Z",
    confidence: 0.8,
    evidence: "Cursor integrates Claude Sonnet for coding",
  },
  {
    source_id: "cursor",
    target_id: "openai/gpt-4o",
    ...
    discovered_at: "2024-05-13T00:00:00Z",
    confidence: 0.8,
    evidence: "Cursor also integrates GPT-4o",
  },

  // competes_with relationships
  {
    source_id: "openai/gpt-4o",
    target_id: "anthropic/claude-4-opus",
    relationship: "competes_with",
    discovered_at: "2025-05-22T00:00:00Z",
    confidence: 0.95,
    evidence: "Direct frontier model competitors",
  },
  {
    source_id: "openai/gpt-4o",
    target_id: "google/gemini-2-5-pro",
  ...
  },
  {
    ...
    discovered_at: "2025-03-25T00:00:00Z",
    confidence: 0.9,
    evidence: "Competing frontier models",
  },
  {
    source_id: "openai/chatgpt",
    target_id: "perplexity",
    relationship: "competes_with",
    discovered_at: "2024-01-01T00:00:00Z",
    confidence: 0.7,
    evidence: "ChatGPT and Perplexity compete in AI-assisted search",
  },
  {
    source_id: "github/copilot",
    target_id: "cursor",
    relationship: "competes_with",
    discovered_at: "2024-01-01T00:00:00Z",
    confidence: 0.9,
    evidence: "Both are AI-powered coding tools",
  },
  {
    source_id: "github/copilot",
    target_id: "anthropic/claude-code",
    relationship: "competes_with",
    discovered_at: "2025-02-24T00:00:00Z",
    confidence: 0.8,
    evidence: "Both are AI coding assistants",
  },
  {
    source_id: "stability-ai/sd3",
    target_id: "openai/dall-e-3",
    relationship: "competes_with",
    discovered_at: "2024-02-22T00:00:00Z",
    confidence: 0.9,
    evidence: "Competing image generation models",
  },
  {
    source_id: "stability-ai/sd3",
    ...
    discovered_at: "2024-02-22T00:00:00Z",
    confidence: 0.85,
    evidence: "Competing image generation platforms",
  },
  {
    source_id: "meta/llama-4",
    target_id: "mistral/mistral-large",
    relationship: "competes_with",
    discovered_at: "2025-04-05T00:00:00Z",
    confidence: 0.8,
    evidence: "Competing in open-weight model space",
  },
  ...
  // part_of relationships
  {
    ...
    discovered_at: "2023-04-20T00:00:00Z",
    confidence: 0.99,
    evidence: "DeepMind is a division of Google/Alphabet",
  },
  {
    source_id: "anthropic/claude-4-opus",
    target_id: "anthropic/claude-4-sonnet",
    ...
    discovered_at: "2025-05-22T00:00:00Z",
    confidence: 0.85,
    evidence: "Both part of Claude 4 model family",
  },
  {
    source_id: "anthropic/claude-4-haiku",
    target_id: "anthropic/claude-4-sonnet",
  ...
  },
  {
    ...
    discovered_at: "2023-01-01T00:00:00Z",
    confidence: 0.95,
    evidence: "GitHub Copilot is a Microsoft/GitHub product",
  },
  ...
  // funded_by relationships
  {
    ...
    discovered_at: "2023-10-27T00:00:00Z",
    confidence: 0.99,
    evidence: "Google committed $2B investment in Anthropic",
  },
  {
    source_id: "openai",
    target_id: "microsoft",
    relationship: "funded_by",
    discovered_at: "2023-01-23T00:00:00Z",
    confidence: 0.99,
  ...
  },
  {
    ...
    discovered_at: "2024-02-26T00:00:00Z",
    confidence: 0.9,
    evidence: "Microsoft invested in Mistral AI",
  },
  ...
  // partners_with relationships
  {
    ...
    discovered_at: "2023-01-01T00:00:00Z",
    confidence: 0.99,
    evidence: "Deep strategic partnership for Azure OpenAI Service",
  },
  {
    source_id: "anthropic",
    target_id: "google",
    ...
    discovered_at: "2023-10-27T00:00:00Z",
    confidence: 0.95,
    evidence: "Anthropic models available on Google Cloud",
  },
  ...
  // integrates_with relationships
  {
    ...
    discovered_at: "2024-05-13T00:00:00Z",
    confidence: 0.95,
    evidence: "LangChain has official OpenAI integration",
  },
  {
    source_id: "langchain",
    target_id: "anthropic/claude-4-sonnet",
    ...
    discovered_at: "2025-05-22T00:00:00Z",
    confidence: 0.95,
    evidence: "LangChain has official Anthropic integration",
  },
  {
    ...
    discovered_at: "2024-05-13T00:00:00Z",
    confidence: 0.9,
    evidence: "LlamaIndex supports OpenAI models",
  },
  {
    source_id: "vllm",
    target_id: "meta/llama-4",
    ...
    discovered_at: "2025-04-05T00:00:00Z",
    confidence: 0.9,
    evidence: "vLLM supports serving Llama models",
  },
  {
    source_id: "vllm",
    target_id: "mistral/mistral-large",
    ...
    discovered_at: "2024-02-26T00:00:00Z",
    confidence: 0.85,
    evidence: "vLLM supports serving Mistral models",
  },
  ...
  // benchmarked_on relationships
  {
    source_id: "openai/gpt-4o",
    target_id: "mmlu",
    relationship: "benchmarked_on",
    discovered_at: "2024-05-13T00:00:00Z",
    confidence: 0.95,
    evidence: "GPT-4o evaluated on MMLU",
  },
  {
    source_id: "anthropic/claude-4-opus",
    target_id: "mmlu",
    ...
    discovered_at: "2025-05-22T00:00:00Z",
    confidence: 0.95,
    evidence: "Claude 4 Opus evaluated on MMLU",
  },
  {
    source_id: "google/gemini-2-5-pro",
    target_id: "mmlu",
    ...
    discovered_at: "2025-03-25T00:00:00Z",
    confidence: 0.95,
    evidence: "Gemini 2.5 Pro evaluated on MMLU",
  },
  {
    source_id: "openai/gpt-4o",
    target_id: "humaneval",
    ...
    discovered_at: "2024-05-13T00:00:00Z",
    confidence: 0.9,
    evidence: "GPT-4o evaluated on HumanEval",
  },
  {
    source_id: "anthropic/claude-code",
    target_id: "swebench",
    ...
    discovered_at: "2025-02-24T00:00:00Z",
    confidence: 0.9,
    evidence: "Claude Code evaluated on SWE-bench",
  },
  {
    source_id: "anthropic/claude-4-opus",
    target_id: "swebench",
    ...
    discovered_at: "2025-05-22T00:00:00Z",
    confidence: 0.9,
    evidence: "Claude 4 Opus evaluated on SWE-bench",
  },

  // inspired_by relationships
  {
    source_id: "paper/constitutional-ai",
    target_id: "paper/scaling-laws",
    relationship: "inspired_by",
    discovered_at: "2022-12-15T00:00:00Z",
    confidence: 0.6,
    evidence: "Constitutional AI builds on insights from scaling research",
  },
  {
    source_id: "meta/llama-3",
    target_id: "paper/attention-is-all-you-need",
    relationship: "inspired_by",
    discovered_at: "2024-04-18T00:00:00Z",
    confidence: 0.95,
    evidence: "Llama uses transformer architecture",
  },
  {
    source_id: "openai/gpt-4",
    target_id: "paper/attention-is-all-you-need",
    ...
    discovered_at: "2023-03-14T00:00:00Z",
    confidence: 0.95,
    evidence: "GPT-4 is a transformer model",
  },

  // forked_from relationships
  {
    source_id: "cursor",
    target_id: "github/copilot",
    relationship: "inspired_by",
    discovered_at: "2023-06-01T00:00:00Z",
    confidence: 0.7,
    evidence: "Cursor drew inspiration from Copilot's AI coding paradigm",
  },
  {
    source_id: "vllm",
    target_id: "huggingface/transformers",
    relationship: "built_on",
    discovered_at: "2023-06-20T00:00:00Z",
    confidence: 0.8,
    evidence: "vLLM builds on HuggingFace model loading",
  },

  // Training infrastructure
  {
    source_id: "openai/gpt-4o",
    target_id: "nvidia/h100",
    relationship: "built_on",
    discovered_at: "2024-05-13T00:00:00Z",
    confidence: 0.85,
    evidence: "GPT-4o trained on NVIDIA GPU clusters",
  },
  {
    source_id: "anthropic/claude-4-opus",
    target_id: "nvidia/h100",
    ...
    discovered_at: "2025-05-22T00:00:00Z",
    confidence: 0.8,
    evidence: "Claude models trained on NVIDIA GPUs",
  },
  {
    source_id: "meta/llama-4",
    target_id: "nvidia/h100",
    ...
    discovered_at: "2025-04-05T00:00:00Z",
    confidence: 0.85,
    evidence: "Llama 4 trained on NVIDIA GPU clusters",
  },
  {
    source_id: "meta/llama-4",
    target_id: "pytorch",
    ...
    discovered_at: "2025-04-05T00:00:00Z",
    confidence: 0.95,
    evidence: "Llama models built with PyTorch",
  },
  {
    source_id: "huggingface/transformers",
    target_id: "pytorch",
    ...
    discovered_at: "2023-01-01T00:00:00Z",
    confidence: 0.95,
    evidence: "Transformers library uses PyTorch as primary backend",
  },

  // Data relationships
  {
    source_id: "meta/llama-3",
    target_id: "dataset/common-crawl",
    relationship: "built_on",
    discovered_at: "2024-04-18T00:00:00Z",
    confidence: 0.85,
    evidence: "Llama 3 pre-training data includes Common Crawl",
  },
  ...
  // acquired_by relationships
  {
    ...
    discovered_at: "2023-04-20T00:00:00Z",
    confidence: 0.99,
    evidence: "DeepMind acquired by Google in 2014, merged with Brain in 2023",
  },
  ...
  // forked_from relationships
  {
    ...
    discovered_at: "2023-06-20T00:00:00Z",
    confidence: 0.7,
    evidence: "vLLM originally forked model loading code from Transformers",
  },
  {
    source_id: "mistral/mistral-large",
    target_id: "meta/llama-3",
    relationship: "inspired_by",
    discovered_at: "2024-02-26T00:00:00Z",
    confidence: 0.5,
    evidence: "Mistral founders from Meta, influenced by Llama architecture",
  },
  {
    source_id: "llamaindex",
    target_id: "langchain",
    ...
    discovered_at: "2023-01-01T00:00:00Z",
    confidence: 0.6,
    evidence: "LlamaIndex emerged in similar space as LangChain",
  },
  ...
  // Additional benchmarked_on
  {
    ...
    discovered_at: "2025-04-05T00:00:00Z",
    confidence: 0.95,
    evidence: "Llama 4 evaluated on MMLU",
  },
  {
    source_id: "anthropic/claude-4-sonnet",
    target_id: "humaneval",
    ...
    discovered_at: "2025-05-22T00:00:00Z",
    confidence: 0.9,
    evidence: "Claude 4 Sonnet evaluated on HumanEval",
  },
  {
    source_id: "google/gemini-2-5-pro",
    target_id: "humaneval",
    ...
    discovered_at: "2025-03-25T00:00:00Z",
    confidence: 0.9,
    evidence: "Gemini 2.5 Pro evaluated on HumanEval",
  },
  ...
  // Additional integrates_with
  {
    ...
    discovered_at: "2025-03-25T00:00:00Z",
    confidence: 0.9,
    evidence: "LangChain has Google GenAI integration",
  },
  {
    source_id: "cursor",
    target_id: "google/gemini-2-5-pro",
    ...
    discovered_at: "2025-03-25T00:00:00Z",
    confidence: 0.75,
    evidence: "Cursor supports Gemini models",
  },
  ...
  // Additional competes_with
  {
    ...
    discovered_at: "2023-01-01T00:00:00Z",
    confidence: 0.75,
    evidence: "Both are LLM application frameworks",
  },
];
...
async function seedNeo4j() {
  ...
  try {
    ...
    console.log(
      `Neo4j seeded: ${nodeCount.records[0].get("count")} nodes, ${edgeCount.records[0].get("count")} edges`,
    );
  } finally {
    await session.close();
    await driver.close();
